...
{
    py::class_<Staircase::Params>(m, "Params")
        .def(py::init<double, std::vector<double>, unsigned int, int, int,
                      bool, psydapt::Scale, std::optional<unsigned int>, std::optional<double>,
                      std::optional<double>>(),
    ...
    py::class_<Staircase>(m, "Staircase")
